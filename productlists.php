...
<body>
    ...
    <div class="container mt-5">
        <h2>Products in '<?php echo $searchQuery; ?>'</h2>
        <div class="row">
            <?php
            if (!empty($searchQuery)) {
                $stmt = $conn->prepare("SELECT product_id, name, image_url FROM products WHERE category = ?");
            ...
            <?php
                    ...
                    echo "<h2>No products found in '$searchQuery'</h2>";
                }
